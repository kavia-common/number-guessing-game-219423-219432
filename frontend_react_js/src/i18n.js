...
const resources = {
  en: {
    translation: {
      ...
      statistics_close: 'Close',
      statistics_group_aria: 'Overall gameplay statistics',
      stats_total_games: 'Total Games Played',
      stats_highest_score: 'Highest Score',
      stats_fastest_win: 'Fastest Win',
  ...
  te: {
    translation: {
      ...
      statistics_close: 'మూసివేయి',
      statistics_group_aria: 'మొత్తం ఆట గణాంకాలు',
      stats_total_games: 'ఆడిన మొత్తం ఆటలు',
      stats_highest_score: 'అత్యధిక స్కోరు',
      stats_fastest_win: 'త్వరిత విజయం',
      stats_average_attempts: 'సగటు ప్రయత్నాలు (విజయాలు)',
      stats_not_available: 'లేదు',
      statistics_hint: 'మొత్తాల్లో విజయాలు, పరాజయాలు, సమయం ముగిసిన రౌండ్లు ఉన్నాయి. టైమర్ ఛాలెంజ్ డేటా ఉన్నప్పుడు మాత్రమే త్వరిత విజయం లెక్కిస్తాం.',
      // Achievements
  ...
  hi: {
    translation: {
      ...
      statistics_close: 'बंद करें',
      statistics_group_aria: 'कुल गेम सांख्यिकी',
      stats_total_games: 'खेले गए कुल खेल',
      stats_highest_score: 'सर्वोच्च स्कोर',
      stats_fastest_win: 'सबसे तेज़ जीत',
      stats_average_attempts: 'औसत प्रयास (जीत)',
      stats_not_available: 'उपलब्ध नहीं',
      statistics_hint: 'कुल में जीत, हार और समय-उपरांत राउंड शामिल हैं। सबसे तेज़ जीत टाइमर चैलेंज मेटाडेटा पर आधारित है जब उपलब्ध हो।',
      // Achievements
