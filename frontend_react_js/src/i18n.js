...
const resources = {
  ...
  te: {
    translation: {
      ...
      timerEnableLabel: 'టైమర్ మోడ్‌ను ప్రారంభించండి',
      ...
      current_range: 'ప్రస్తుతం శ్రేణి: {{min}} నుండి {{max}} ({{label}})',
      ...
      new_game: 'కొత్త ఆట',
      play_again: 'మళ్లీ ఆడు',
      reset: 'రిసెట్',
      hint_group: 'సూచన ఎంపికలు',
      hints_note: 'సూచనలు మీ స్కోరు తగ్గిస్తాయి. ప్రతి రకానికి ఒక శిక్ష ఉంటుంది.',
      ...
      hint_proximity_very_close: 'సూచన: మీరు చాలా దగ్గరలో ఉన్నారు.',
      hint_proximity_hot: 'సూచన: హాట్.',
      hint_proximity_warm: 'సూచన: వార్మ్.',
      hint_proximity_cold: 'సూచన: కోల్డ్.',
      hint_proximity_after_valid: 'సూచన: చెల్లుబాటు అయ్యే గెస్ తరువాత అందుబాటులో ఉంటుంది.',
      leaderboard_title: 'లీడర్బోర్డ్',
      leaderboard_close: 'మూసివేయి',
      leaderboard_clear: 'లీడర్బోర్డ్ క్లియర్ చేయి',
      leaderboard_clear_confirm: 'అన్ని ఎంట్రీలను క్లియర్ చేయాలా? ఈ చర్యను రద్దు చేయలేరు.',
      ...
      leaderboard_hint: 'మీ మొదటి ఫలితాన్ని జోడించడానికి ఒక ఆటను గెలవండి!',
      ...
      achievements_unlocked: 'అన్లాక్ అయ్యింది',
      achievements_locked: 'లాక్ అయ్యింది',
      ...
      ach_firstTryWin_desc: 'కచ్చితంగా 1 ప్రయత్నంలో రౌండ్ గెలుచుకోండి.',
      ach_noHintsWin_title: 'సూచనల లేకుండా విజయం',
      ach_noHintsWin_desc: 'ఏ సూచన లేకుండా రౌండ్ గెలుచుకోండి.',
  ...
  hi: {
    translation: {
      ...
      feedback_low: 'बहुत कम। बड़ी संख्या आज़माएं।',
      feedback_high: 'बहुत अधिक। छोटी संख्या आज़माएं।',
      ...
      hints_note: 'संकेत आपके स्कोर को कम करते हैं। प्रत्येक प्रकार पर दंड लागू होता है।',
      ...
      hint_digit_text_single: 'संकेत: यह एक अंक की संख्या है और {{digit}} से शुरू होती है।',
      ...
      hint_proximity_very_close: 'संकेत: आप बहुत पास हैं।',
      ...
      leaderboard_clear_confirm: 'सभी प्रविष्टियाँ साफ़ करें? यह कार्रवाई पूर्ववत नहीं की जा सकती।',
      leaderboard_views: 'लीडरबोर्ड दृश्य',
      leaderboard_tab_scores: 'उच्च स्कोर',
      leaderboard_tab_attempts: 'सर्वश्रेष्ठ प्रयास',
      leaderboard_empty: 'अभी तक कोई परिणाम नहीं।',
      leaderboard_hint: 'अपना पहला परिणाम जोड़ने के लिए एक खेल जीतें!',
      ...
      ach_noHintsWin_title: 'बिना संकेत के जीत',
